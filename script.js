...
//Second description is appearing from bottom - will be triggered in mainTrigger on scrolling
const showSecondDescription = () => {
	const descTwoRect = descriptionTwo.getBoundingClientRect();
	const y = descTwoRect.top + descTwoRect.height /1.5;
	
	if (y < window.innerHeight) {
		descriptionTwo.classList.add("appearing-from-bottom");
	};
};
